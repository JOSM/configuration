...
public class JosmConfigPlugin extends Plugin {

    public JosmConfigPlugin(PluginInformation info) {
        super(info);
        ...
        try {
            ...
            for (int i = 0; i < tasksArray.size(); i++) {
                ...
                loadTaskMenu.add(new JMenuItem(new JosmConfigLayerAction(task.getString("name"),task.getString("URL"))));
            }
        } catch (Exception e1) {
            e1.printStackTrace();
